...
SECRET_KEY = 'django-insecure-h^kd24841@o)fowznl=nz5hbp@(@s$x#(j5+ltz#nukyeu-&*1'
...
EMAIL_HOST_USER = 'findora.campus@gmail.com'
EMAIL_HOST_PASSWORD = 'FindoraPass123'
DEFAULT_FROM_EMAIL = "findora.campus@gmail.com"
